    ...
    <Box sx={{ flexGrow: 1, width: '100%', margin: '0' }}>
      ...
      >
        <Toolbar>
          ...
          >
            <MenuItem onClick={handleMenuClose} sx={navMenuStyle}>Home</MenuItem>         
            <MenuItem onClick={handleMenuClose} sx={navMenuStyle}>Events</MenuItem>            
            <MenuItem onClick={handleMenuClose} sx={navMenuStyle}>Team</MenuItem>
            <MenuItem onClick={handleMenuClose} sx={navMenuStyle}>Sponsor</MenuItem>
            <MenuItem onClick={handleMenuClose} sx={navMenuStyle}>Schedule</MenuItem>
          </Menu>

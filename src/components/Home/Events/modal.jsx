    ...
    <div className="main-modal">
        ...
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content"onClick={(e) => e.stopPropagation()}>
            ...
            <EventBox image={'https://d8it4huxumps7.cloudfront.net/uploads/images/opportunity/mobile_banner/6780cdc773102_battle-of-bands.webp?d=700x400'} title={"Battle of Bands"} handleClick={()=>handleRedirect("https://unstop.com/college-fests/technovate-60-international-institute-of-information-technology-iiit-naya-raipur-306352")}/>
